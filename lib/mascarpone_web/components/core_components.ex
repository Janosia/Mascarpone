defmodule MascarponeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MascarponeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MascarponeWeb.Gettext, "errors", msg, opts)
    end
  end
